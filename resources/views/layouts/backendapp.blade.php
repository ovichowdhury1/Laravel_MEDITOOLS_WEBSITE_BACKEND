...
<head>
    ...
    <!--Swiper slider css-->
    <link href="{{asset('assets/backend/libs/jsvectormap/css/jsvectormap.min.css/swiper/swiper-bundle.min.css')}}" rel="stylesheet" type="text/css" />
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{}}" class="nav-link" data-key="t-analytics"> ADD BANNERS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="dashboard-crm.html" class="nav-link" data-key="t-crm"> ALL BANNERS </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
